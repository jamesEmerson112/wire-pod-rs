...
| `f32json` | `pkg/vars/config.go:38-39`, Go's `encoding/json/encode.go:538-577` | How a `float32` struct field marshals, including both format cutoffs and the two-digit negative exponent cleanup |
...
|---|---|---|---|
| `go-probe/expected.txt` | 302 | 7 | 295 |
